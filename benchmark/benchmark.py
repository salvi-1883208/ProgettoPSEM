...
executables = []
if "c" in input:
    executables.append("cuda")
if "s" in input:
    executables.append("serial")
if "m" in input:
    executables.append("mpi")
...
rands = [1234, 5678, 9012, 3456, 7890, 4321, 8765, 2109]

# number of processors
processors_cuda = [256, 453, 797, 1024]
...
for executable in executables:
    filename = "results/" + executable + "_" + "results.csv"
    results = {}
    for size in sizes:
    ...
    print("\n{} results saved in {}.".format(executable, filename))
